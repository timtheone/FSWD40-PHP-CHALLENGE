...
--
-- Host: localhost
-- Generation Time: Jun 20, 2018 at 10:16 AM
...
INSERT INTO `driver` (`driver_id`, `first_name`, `last_name`, `birthday`, `CarLicence`, `adress`, `email`, `password`) VALUES
(1, 'Horst', 'Koch', '1985-12-30', 123456789, 'Am Teich 5', 'hk@gmx.at', 'horst'),
(2, 'Denise', 'Light', '1995-01-05', 891234567, 'Kettenbrückengasse 4', 'dl@gmail.at', 'denise'),
(3, 'Marielen', 'Haider', '1987-08-22', 678912345, 'Am Damm 5', 'mh@hotmail.at', 'marie');
